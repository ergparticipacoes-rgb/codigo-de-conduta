...
export function BreakBeliefSection() {
  return (
    <section
      className="border-y border-white/[0.06] bg-elevated/45 py-14 sm:py-[4.25rem] md:py-20 lg:py-24"
      ...
      <Container>
        ...
        <div className="grid gap-7 md:grid-cols-2 md:gap-8 lg:gap-10">
          <SurfaceCard>
            ...
            <p className="mt-7 whitespace-pre-line border-l-2 border-accent/80 pl-5 text-base font-medium leading-[1.66] text-ink sm:text-lg">
