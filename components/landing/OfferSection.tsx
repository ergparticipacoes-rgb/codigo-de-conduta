  ...
  return (
    ...
    >
      <Container>
        ...
        />
        <div className="mt-10 grid items-start gap-8 sm:mt-12 md:gap-10 lg:mt-14 lg:grid-cols-12 lg:gap-14">
          ...
          <div className="lg:col-span-7">
            <SurfaceCard className="h-full">
              <div>
                ...
                <ul className="mt-6 space-y-7 sm:space-y-8">
              ...
              <div className="mt-11 border-t border-white/[0.1] pt-10 sm:mt-12 sm:pt-11">
                <div className="my-6 rounded-r-xl border-l-2 border-accent/45 bg-white/[0.04] py-5 pl-5 pr-4 sm:my-8 sm:py-6 sm:pl-6 sm:pr-5">
              ...
              <div
                id="comprar"
                className="mt-10 flex scroll-mt-28 justify-center border-t border-white/[0.1] pt-12 sm:mt-12 sm:pt-14"
              >
