...
export function HeroSection() {
  return (
    <section
      id="top"
      className="relative overflow-hidden border-b border-white/[0.06] pb-16 pt-12 sm:pb-[5.25rem] sm:pt-16 md:pb-24 md:pt-[4.25rem] lg:pb-28 lg:pt-20"
    ...
    >
      ...
      />
      <Container>
        <div className="grid items-center gap-8 md:gap-10 lg:grid-cols-12 lg:gap-12 xl:gap-14">
          <div className="lg:col-span-7">
            ...
            <h1
              id="hero-heading"
              className="max-w-[36rem] font-display text-[1.875rem] font-semibold leading-[1.11] tracking-[-0.035em] text-ink text-balance sm:text-[2.25rem] sm:leading-[1.09] md:max-w-[40rem] md:text-[2.75rem] md:leading-[1.07] lg:text-[3.125rem] lg:leading-[1.06] xl:text-[3.5rem] xl:leading-[1.05]"
            >
              {HERO.headline}
            </h1>
            <p className="mt-7 max-w-xl text-base leading-[1.66] text-ink-muted sm:mt-8 sm:text-lg sm:leading-[1.62]">
              {HERO.subheadline}
            </p>
            <div className="mt-8 flex max-w-xl flex-col gap-3 sm:mt-10 sm:flex-row sm:items-center sm:gap-4">
              <CTAButton
            ...
            <p className="mt-8 max-w-lg text-base leading-[1.65] text-ink-muted sm:mt-10 sm:text-lg sm:leading-[1.62]">
              {HERO.support}
            </p>
          </div>
