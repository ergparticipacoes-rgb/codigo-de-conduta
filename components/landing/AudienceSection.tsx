...
export function AudienceSection() {
  return (
    <section
      className="border-t border-white/[0.06] bg-elevated/40 py-12 sm:py-[4.25rem] md:py-20 lg:py-24"
    ...
    >
      <Container>
        ...
        <div className="mx-auto mt-8 grid max-w-5xl gap-5 sm:mt-12 sm:gap-6 md:grid-cols-2 md:gap-7 lg:mt-14">
